...
var style_caminos_rurales_34 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var style = [ new ol.style.Style({
        stroke: new ol.style.Stroke({color: 'rgba(134,67,0,1.0)', lineDash: null, lineCap: 'square', lineJoin: 'bevel', width: 2}),
